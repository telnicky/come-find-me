  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved broadcast as @broadcast" do
        ...
        post :create, {:broadcast => { "user_id" => "invalid value" }}, valid_session
        assigns(:broadcast).should be_a_new(Broadcast)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested broadcast" do
        ...
        Broadcast.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => broadcast.to_param, :broadcast => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the broadcast as @broadcast" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Broadcast.any_instance.stub(:save).and_return(false)
        put :update, {:id => broadcast.to_param, :broadcast => { "user_id" => "invalid value" }}, valid_session
        assigns(:broadcast).should eq(broadcast)
      end
